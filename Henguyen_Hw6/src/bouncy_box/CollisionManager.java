...
/**
 * This class performs all collision detection using AABBs and a continuous
 * collision detection algorithm.
 */
public class CollisionManager {

    /**
     * Called each frame, this method performs all collision testing for our
     * game. It goes through the array of BouncyBoxes and tests to see if each
    ...
    public static void performCollisionTests(BouncyBox player, BouncyBox[] bouncyBoxes, int worldWidth, int worldHeight) {
        boolean playerWasCollidingLastFrame = player.isColliding();
    ...
    /**
     * This method calculates and returns the time during a frame of a collision
     * between two boxes.
     */
    ...
    /**
     * For any given axis, this method can determine the start time of collision
     * using AABBs.
     */
    ...
    /**
     * This method calculates the time of the first collision on a given axis
     * assuming pos1 < pos2.
     */
    ...
    /**
     * For any given axis, this method can determine the end time of collision
     * using AABBs. This means the instant when two colliding boxes are about to
     * be colliding no more.
     */
    ...
    /**
     * This method calculates the end time of collision on a given axis assuming
     * pos1 < pos2.
     */
    ...
    /**
     * This method moves the box argument ahead per its velocity to the moment
     * in a frame represented by the time argument. We should also make sure not
     * to move it outside the game world.
     */
